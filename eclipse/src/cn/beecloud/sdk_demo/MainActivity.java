...
public class MainActivity extends BCActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        BCPay.initWechatPay(MainActivity.this);
        ...
        listViewOrder.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (PayTag == 0) {
                    BCPay.getInstance(MainActivity.this).refundWxPayStartRefundAsync(
                        out_trade_no, "201101120001", "1", "退款原因！", new BCCallback() {
                        @Override
                    ...
                    BCPay.getInstance(MainActivity.this).reqAliRefundAsync(
                        out_trade_no, "201101120001", "0.01", "退款原因！", new BCCallback() {
                        @Override
                        public void done(BCResult bcResult) {
                    ...
                    BCPay.getInstance(MainActivity.this).reqUnionRefundAsync(
                        out_trade_no, "1", "201101120001", "退款原因", new BCCallback() {
                        @Override
                        public void done(BCResult bcResult) {
                            Message msg = mHandler
                                            .obtainMessage();
            ...
            public void onClick(View v) {
                try {
                    ...
                    BCPay.getInstance(MainActivity.this).reqWXPaymentV3Async(
                        "test", "1", BCUtil.generateRandomUUID().replace("-", ""), "BeeCloud-Android", mapOptional, new BCCallback() {
                        @Override
                        public void done(BCResult bcResult) {
            ...
            public void onClick(View v) {
                try {
                    ...
                    pay.queryOrderByKeyAsync(
                        BCPay.BCPayOrderKey.OrderKeyTraceID, "BeeCloud-Android", BCPay.BCPayOrderType.BCPayWxPay, new BCArrayResultCallback() {
                        @Override
            ...
            public void onClick(View v) {
                try {
                    ...
                    BCPay.getInstance(MainActivity.this).reqAliPaymentAsync(
                        "test", BCUtil.generateRandomUUID().replace("-", ""), "订单标题", "对一笔交易的具体描述信息", "0.01", mapOptional, new BCCallback() {
                        @Override
                        public void done(BCResult bcResult) {
        ...
        btnAliPayOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    BCPay pay = BCPay.getInstance(MainActivity.this);
                    pay.queryOrderByKeyAsync(
                        BCPay.BCPayOrderKey.OrderKeyTraceID, "2088002375457915", BCPay.BCPayOrderType.BCPayAliPay, new BCArrayResultCallback() {
                        @Override
                        public void done(List<Map<String, Object>> lstMaps) {
                            System.out.println("lstMaps" + lstMaps.size());
                            mListMaps = lstMaps;
            ...
            public void onClick(View v) {
                try {
                    ...
                    BCPay.getInstance(MainActivity.this).reqUnionPaymentByAPKAsync(
                        "Android-UPPay", "Android-UPPay-body", BCUtil.generateRandomUUID().replace("-", ""), "1", mapOptional, new BCCallback() {
                        @Override
                        public void done(BCResult bcResult) {
        ...
        btnUPPayOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    BCPay pay = BCPay.getInstance(MainActivity.this);
                    pay.queryOrderByKeyAsync(
                        BCPay.BCPayOrderKey.OrderKeyTraceID, "Android-UPPay", BCPay.BCPayOrderType.BCPayUPPay, new BCArrayResultCallback() {
                        @Override
                        public void done(List<Map<String, Object>> lstMaps) {
                            System.out.println("lstMaps" + lstMaps.size());
                            mListMaps = lstMaps;
